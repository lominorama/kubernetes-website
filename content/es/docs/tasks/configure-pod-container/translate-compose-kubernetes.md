...
¿Qué es Kompose? Es una herramienta para convertir aplicaciones contenerizadas definidas en formato Docker Compose a un formato apropiado para orquestradores de contedores (Kubernees u OpenShift).

Puedes encontrar más información en el sitio web de Kompose en [http://kompose.io](http://kompose.io).
...
Hay muchas maneras de instalar Kompose, pero nuestro método preferido es descargar el binario de la última release disponible en GitHub.

## GitHub release

Kompose publica nuevas versiones a través de GitHub en ciclos de tres semanas. Pudes ver todas las versiones publicadas actualmente en la [página de releases de GitHub](https://github.com/kubernetes/kompose/releases).
...
# Windows
curl -L https://github.com/kubernetes/kompose/releases/download/v1.18.0/kompose-windows-amd64.exe -o kompose.exe

chmod +x kompose
sudo mv ./kompose /usr/local/bin/kompose
```

Alternativamente, también puedes descargarte el [tarball](https://github.com/kubernetes/kompose/releases).

## Go

Instalar Kompose vía `go get` descargará la rama master del proyecto con los últimos cambios.
...
Kompose está presente en los repositorios de Fedora 24, 25 y 26. Puedes instalarlo como cualquier otro paquete.
...
En macOS puedes instalar la última release mediante [Homebrew](https://brew.sh):
